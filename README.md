...
The largest words, such as “nervous,” “excited,” “anxious,” “worried,” and “unsure,” are the most frequently mentioned feelings. This prominence indicates that these emotions are the most common among the students regarding their course experience. Positive sentiments like “excited,” “hopeful,” and “ready” are shown in green, while negative emotions such as “nervous,” “anxious,” and “worried” are depicted in red, highlighting a mix of optimism and stress. The complexity of emotions is reflected in words like “confused,” “overwhelmed,” and “apprehensive,” indicating the demanding nature of the course. 


## Report Summary 


Initially, we held a meeting on the direction we would take for this assignment. As a team we decided we will focus on sentiment classification, such as positive and negative. After addressing some input errors and word repetition with our data cleaning processes, our team suggested using the ggwordcloud package to build a visually interesting representation of data.

The ggwordcloud package allows us to display word frequency in a visually appealing manner, where the size of each word is proportional to its appearance in the text. These words can be arranged in various formats, such as horizontal lines, vertical columns, or be shaped to fill custom images, creating a visually engaging cloud pattern.

At the beginning, the images we created had a lot of colours. Although they had a great visual impact, we couldn't intuitively see the differences between words and the classifications we made. Therefore, we simplified the classification for each word by roughly dividing all words into two emotions and using colours to distinguish them, expressing frequency in different sizes. 

Overall, our team has created an clear and effective graphic that conveys the mixed emotional responses from the students, highlighting both the positive and negative sentiments associated students expectations for Stats399. 
